...
\section*{Solution}
\begin{enumerate}
    \item Two random variables $X$ and $Y$ are independent when
    \begin{align}
...
\end{align}
for all $a,b\in R$.\\
As the joint probability of random variables is product of their individual probabilities, $X$ and $Y$ are independent. \\
...
\end{align}
    ...
    Counterexample: Let $X\sim U \sbrak{-1,1}$ be a uniformly distributed random variable.
    \begin{align}
        f_X\brak{x}=
        \begin{cases}
